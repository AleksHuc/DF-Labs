...
To view the Master Boot Record (MBR) or of the first sector on the disk, which contains the bootloader and the partition table, we will use the [`radare2`](https://github.com/radareorg/radare2) tool, which we install from their repository.
