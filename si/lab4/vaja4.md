...
Za branje metapodatkov lahko uporabimo namenska orodja, kot sta  [`exiv2`](https://linux.die.net/man/1/exiv2), [`exif`](https://manpages.debian.org/bullseye/exif/exif.1.en.html) in [`exiftool`](https://linux.die.net/man/1/exiftool). Z njima lahko dostopamo do vseh metapodatkov, ki so shranjeni v sliki in ne le do tistih, ki jih prikaže program za prikazovanje slik. Namestimo jo z upraviteljem paketov na našem operacijskem sistemu in z njima izpišemo metapodatke naših dveh slik
