...
Poleg tega se je izkazalo, da je 2^24 sektorjev (16.777.216 * 512B = 8.589.934.592B = 8.58GB) prav tako premalo. V prostor, ki je bil v vsakem razdelku rezerviran, so dodali 32-bitni začetek razdelka v [Logical Block Addressing (LBA)](https://en.wikipedia.org/wiki/Logical_block_addressing) formatu ter 32-bitno dolžino v številu sektorjev.
